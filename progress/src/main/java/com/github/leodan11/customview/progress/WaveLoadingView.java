...
public class WaveLoadingView extends View {
    ...
    public void onDraw(@NonNull Canvas canvas) {
        ...
        if (mWaveShader != null) {
            ...
            // Sale shader according to waveLengthRatio and amplitudeRatio.
            ...
            switch (mShapeType) {
                ...
                case 0:
                    ...
                    @SuppressLint("DrawAllocation") Point start = new Point(0, getHeight());
                ...
                case 3:
                    if (mIsRoundRectangle) {
                        if (borderWidth > 0) {
                            @SuppressLint("DrawAllocation") RectF rect = new RectF(borderWidth / 2f, borderWidth / 2f, getWidth() - borderWidth / 2f - 0.5f, getHeight() - borderWidth / 2f - 0.5f);
            ...
            if (!TextUtils.isEmpty(mCenterTitle)) {
                ...
                canvas.drawText(mCenterTitle, (getWidth() - middle) / 2,
                        (float) getHeight() / 2 - ((mCenterTitleStrokePaint.descent() + mCenterTitleStrokePaint.ascent()) / 2), mCenterTitleStrokePaint);
                // Draw the centered text
                canvas.drawText(mCenterTitle, (getWidth() - middle) / 2,
                        (float) getHeight() / 2 - ((mCenterTitlePaint.descent() + mCenterTitlePaint.ascent()) / 2), mCenterTitlePaint);
            }
