...
import com.leodan11.textview.model.Slice;
import com.leodan11.textview.span.CircleBackgroundSpan;
import com.leodan11.textview.span.RoundedBackgroundSpan;
...
public class SpannableTextView extends AppCompatTextView {
     ...
     * {@link java.util.List}, so expect the same type of behavior.
     *
     ...
     * structure is a {@link java.util.List}, so expect the same type of behavior.
     *
     ...
     *
     * @param location position of Piece (zero-based)
     ...
     * and want this TextView to display the final, styled version of its String contents.
     * <p>
    ...
    /**
     * Resets the styling of this view and sets its content to an empty String.
     */
    public void reset() {
        sliceList = new ArrayList<>();
        setText("");
