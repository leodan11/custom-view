package com.leodan11.textview.model;

import android.graphics.Color;
import android.graphics.Typeface;

import com.leodan11.textview.callbacks.OnTextClickListener;
...
public class Slice {
    ...
    private final OnTextClickListener onTextClick;
    ...
    public static class Builder {
        ...
        private OnTextClickListener onTextClick;
        private int sliceId;
         ...
         * @return a Builder
         */
        public Builder setOnTextClick(OnTextClickListener onTextClick) {
    ...
    public OnTextClickListener getOnTextClick() {
        return onTextClick;
    }
