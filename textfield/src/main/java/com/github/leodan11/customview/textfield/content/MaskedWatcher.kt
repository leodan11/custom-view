...
open class MaskedWatcher(maskedFormatter: MaskedFormatter, editText: EditText) : TextWatcher {
    ...
    private var beforeTextChanged: ((text: CharSequence?, start: Int, count: Int, after: Int) -> Unit)? =
        null
    private var onTextChanged: ((text: CharSequence?, start: Int, before: Int, count: Int) -> Unit)? =
        null
