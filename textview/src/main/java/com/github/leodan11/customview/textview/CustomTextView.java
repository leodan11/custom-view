...
import com.github.leodan11.customview.textview.utils.Typefaces;
...
public class CustomTextView extends AppCompatTextView implements Checkable {
    ...
    private final String[] defValue = {"more", "less"};
    ...
    private void init(AttributeSet attrs) {
        ...
        paddingLeft = a.getDimensionPixelSize(R.styleable.CustomTextView_android_paddingStart, 5);
        paddingTop = a.getDimensionPixelSize(R.styleable.CustomTextView_android_paddingTop, 5);
        paddingRight = a.getDimensionPixelSize(R.styleable.CustomTextView_android_paddingEnd, 5);
        ...
        checked = checked == null ? ContextCompat.getDrawable(getContext(), android.R.drawable.checkbox_on_background) : checked;
        unChecked = unChecked == null ? ContextCompat.getDrawable(getContext(), android.R.drawable.checkbox_off_background) : unChecked;
        refresh();
        a.recycle();
    }
    ...
    private Drawable getShapeBackground(@ColorInt int color) {
        ...
        if (this.shape == GradientDrawable.OVAL) {
            radius = (Math.max(this.getHeight(), this.getWidth())) / 2;
        } else {
    ...
    private void animateView(final boolean expanded) {
        ...
        valueAnimator.addUpdateListener(animation -> CustomTextView.this.setHeight((int) animation.getAnimatedValue()));
