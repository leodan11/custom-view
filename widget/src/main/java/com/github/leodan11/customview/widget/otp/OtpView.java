package com.github.leodan11.customview.widget.otp;
...
public class OtpView extends AppCompatEditText {
    ...
    private final Drawable itemBackgroundSelected;
    private final Drawable itemBackgroundFilled;
    private final Drawable itemBackgroundExtra;

    private final Drawable itemBackgroundFilledSaved;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int measureItemWidth = (widthSize - this.getPaddingStart() - this.getPaddingEnd() - (otpViewItemCount - 1) * otpViewItemSpacing) / otpViewItemCount;
        otpViewItemWidth = Math.min(measureItemWidth, otpViewItemWidth);
        if (widthMode == MeasureSpec.EXACTLY) {
            width = widthSize;
        } else {
            int boxesWidth =
                    (otpViewItemCount - 1) * otpViewItemSpacing + otpViewItemCount * otpViewItemWidth;
            width = boxesWidth + this.getPaddingEnd() + this.getPaddingStart();
    ...
    private void drawOtpBox(Canvas canvas, int i) {
        ...
        if (i == Objects.requireNonNull(getText()).length() || nextItemToFill == 1) {
     ...
     *              <p> Reference: {@code R.styleable.OtpView_OtpLineColor} </p>
    ...
    /**
     * Sets the line width.
     * <p> Reference: {@code R.styleable.OtpView_OtpLineWidth} </p>
     *
     * @see #getLineWidth()
     */
     ...
     * <p> Reference: {@code R.styleable.OtpView_OtpItemCount} </p>
     *
     * @see #getItemCount()
     */
     ...
     * <p> Reference: {@code R.styleable.OtpView_OtpItemRadius} </p>
     *
     * @see #getItemRadius()
     */
     ...
     * <p> Reference: {@code R.styleable.OtpView_OtpItemSpacing} </p>
     *
     * @see #getItemSpacing()
     */
     ...
     * <p> Reference: {@code R.styleable.OtpView_OtpItemHeight} </p>
     *
     * @see #getItemHeight()
     */
     ...
     * <p> Reference: {@code R.styleable.OtpView_OtpItemWidth} </p>
     *
     * @see #getItemWidth()
     */
     ...
     *                           <p> Reference: {@code R.styleable.OtpView_OtpHideLineWhenFilled} </p>
     */
     ...
     *              <p> Reference: {@code R.styleable.OtpView_android_itemBackground} </p>
     */
     ...
     * <p> Reference: {@code R.styleable.OtpView_OtpCursorWidth} </p>
     *
     * @see #getCursorWidth()
     */
     ...
     *              Do not pass a resource ID. To get a color value from a resource ID, call
     *              {@link androidx.core.content.ContextCompat#getColor(Context, int) getColor}.
     *              <p> Reference: {@code R.styleable.OtpView_OtpCursorColor} </p>
     * @see #getCursorColor()
     */
    ...
    public String getOtp() {
        if (getText() != null) otp = getText().toString();
        return otp;
    }

    public void setOtp(String otp) {
        if (otpViewItemCount != 0 && otp.length() > otpViewItemCount) return;
        this.otp = otp;
        setText(otp);
        requestLayout();
    }
