...
import static com.github.leodan11.customview.widget.speeddial.SpeedDialActionItem.RESOURCE_NOT_SET;
import static com.github.leodan11.customview.widget.SpeedDialView.ExpansionMode.BOTTOM;
import static com.github.leodan11.customview.widget.SpeedDialView.ExpansionMode.LEFT;
import static com.github.leodan11.customview.widget.SpeedDialView.ExpansionMode.RIGHT;
import static com.github.leodan11.customview.widget.SpeedDialView.ExpansionMode.TOP;
...
import com.github.leodan11.customview.widget.speeddial.FabWithLabelView;
import com.github.leodan11.customview.widget.speeddial.SpeedDialActionItem;
import com.github.leodan11.customview.widget.speeddial.SpeedDialOverlayLayout;
import com.github.leodan11.customview.widget.speeddial.ViewGroupUtils;
...
public class SpeedDialView extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
        ...
        fab.show(new OnVisibilityChangedListener() {
            ...
            public void onShown(FloatingActionButton fab) {
                try {
                    ...
                    Class<?> implClass = Objects.requireNonNull(impl).getClass().getSuperclass();
                    Method scale = Objects.requireNonNull(implClass).getDeclaredMethod("setImageMatrixScale", Float.TYPE);
    ...
    public static class SnackbarBehavior extends CoordinatorLayout.Behavior<View> {
        ...
        @Override
        public boolean onLayoutChild(CoordinatorLayout parent, @NonNull View child,
                                     int layoutDirection) {
        ...
        private boolean shouldUpdateVisibility(View dependency, @NonNull View child) {
