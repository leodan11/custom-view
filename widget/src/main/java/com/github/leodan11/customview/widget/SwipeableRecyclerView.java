...
import com.github.leodan11.customview.widget.swipeablerv.SwipedView;
    ...
    private void createSwipedView(@NonNull Context context, AttributeSet attrs) {
        ...
        mSwipedView.setBackgrounds(new int[]{
                typedArray.getResourceId(
                        R.styleable.SwipeableRecyclerView_leftBgColor, android.R.color.white),
                typedArray.getResourceId(
                        R.styleable.SwipeableRecyclerView_rightBgColor, android.R.color.white)
        });
        mSwipedView.setIcons(new int[]{
                typedArray.getResourceId(
