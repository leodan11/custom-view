...
import com.github.leodan11.customview.widget.timeline.Event
import com.github.leodan11.customview.widget.timeline.EventI


class TimelineView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : LinearLayout(context, attrs, defStyleAttr) {
