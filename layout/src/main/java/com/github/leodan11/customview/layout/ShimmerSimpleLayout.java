...
public class ShimmerSimpleLayout extends FrameLayout {
    ...
    public ShimmerSimpleLayout(Context context) {
        this(context, null);
    }

    public ShimmerSimpleLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ShimmerSimpleLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(
                attrs,
                R.styleable.ShimmerSimpleLayout,
                0, 0);

        try {
            shimmerAngle = a.getInteger(R.styleable.ShimmerSimpleLayout_shimmer_md_angle, DEFAULT_ANGLE);
            shimmerAnimationDuration = a.getInteger(R.styleable.ShimmerSimpleLayout_shimmer_md_animation_duration, DEFAULT_ANIMATION_DURATION);
            shimmerColor = a.getColor(R.styleable.ShimmerSimpleLayout_shimmer_md_color, getColor(R.color.shimmer_md_color));
            autoStart = a.getBoolean(R.styleable.ShimmerSimpleLayout_shimmer_md_auto_start, false);
            maskWidth = a.getFloat(R.styleable.ShimmerSimpleLayout_shimmer_md_mask_width, 0.5F);
            gradientCenterColorWidth = a.getFloat(R.styleable.ShimmerSimpleLayout_shimmer_md_gradient_center_color_width, 0.1F);
            isAnimationReversed = a.getBoolean(R.styleable.ShimmerSimpleLayout_shimmer_md_reverse_animation, false);
        } finally {
            a.recycle();
        }
