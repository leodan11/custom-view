    ...
    public void decorate() {
        try {
            ...
            if ( dX > 0 ) {
                ...
                if ( mSwipeRightText != null && !mSwipeRightText.isEmpty() && dX > iconHorizontalMargin + iconSize) {
                ...
                if ( mSwipeLeftText != null && !mSwipeLeftText.isEmpty() && dX < - iconHorizontalMargin - mSwipeLeftPadding[1] - iconSize ) {
                    TextPaint textPaint = new TextPaint();
                    textPaint.setAntiAlias(true);
                    ...
                    int textTop = (int) (viewHolder.itemView.getTop() + ((viewHolder.itemView.getBottom() - viewHolder.itemView.getTop()) / 2.0) + textPaint.getTextSize() / 2);
                    canvas.drawText(mSwipeLeftText, imgLeft - width - ( imgLeft == viewHolder.itemView.getRight() ? iconHorizontalMargin : (float) iconHorizontalMargin /2 ), textTop, textPaint);
                }
            }
        } catch(Exception e) {
