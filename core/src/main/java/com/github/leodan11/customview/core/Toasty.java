...
public class Toasty {
    ...
    public static Toast warning(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), ToastyUtils.getDrawable(context, R.drawable.ic_alert_outline_white),
                ToastyUtils.getColor(context, R.color.warning_color), ToastyUtils.getColor(context, android.R.color.white),
    ...
    public static Toast warning(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, ToastyUtils.getDrawable(context, R.drawable.ic_alert_outline_white),
                ToastyUtils.getColor(context, R.color.warning_color), ToastyUtils.getColor(context, android.R.color.white),
                duration, withIcon, true);
    }
    ...
    public static Toast info(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), ToastyUtils.getDrawable(context, R.drawable.ic_information_white),
                ToastyUtils.getColor(context, R.color.info_color), ToastyUtils.getColor(context, android.R.color.white),
                duration, withIcon, true);
    }

    @CheckResult
    public static Toast info(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, ToastyUtils.getDrawable(context, R.drawable.ic_information_white),
                ToastyUtils.getColor(context, R.color.info_color), ToastyUtils.getColor(context, android.R.color.white),
                duration, withIcon, true);
    }
    ...
    public static Toast success(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), ToastyUtils.getDrawable(context, R.drawable.ic_check_white),
                ToastyUtils.getColor(context, R.color.success_color), ToastyUtils.getColor(context, android.R.color.white),
                duration, withIcon, true);
    }

    @CheckResult
    public static Toast success(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, ToastyUtils.getDrawable(context, R.drawable.ic_check_white),
                ToastyUtils.getColor(context, R.color.success_color), ToastyUtils.getColor(context, android.R.color.white),
                duration, withIcon, true);
    }
    ...
    public static Toast error(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), ToastyUtils.getDrawable(context, R.drawable.ic_alert_circle_white),
                ToastyUtils.getColor(context, R.color.error_color), ToastyUtils.getColor(context, android.R.color.white),
                duration, withIcon, true);
    }

    @CheckResult
    public static Toast error(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, ToastyUtils.getDrawable(context, R.drawable.ic_alert_circle_white),
                ToastyUtils.getColor(context, R.color.error_color), ToastyUtils.getColor(context, android.R.color.white),
                duration, withIcon, true);
    }
    ...
    public static Toast custom(@NonNull Context context, @StringRes int message, Drawable icon,
        ...
        return custom(context, context.getString(message), icon, -1, ToastyUtils.getColor(context, android.R.color.white),
    ...
    public static Toast custom(@NonNull Context context, @NonNull CharSequence message, Drawable icon,
                               int duration, boolean withIcon) {
        return custom(context, message, icon, -1, ToastyUtils.getColor(context, android.R.color.white),
                duration, withIcon, false);
    }
    ...
    public static Toast custom(@NonNull Context context, @StringRes int message, @DrawableRes int iconRes,
        ...
        return custom(context, context.getString(message), ToastyUtils.getDrawable(context, iconRes),
                ToastyUtils.getColor(context, tintColorRes), ToastyUtils.getColor(context, android.R.color.white),
    ...
    public static Toast custom(@NonNull Context context, @StringRes int message, Drawable icon,
        ...
        return custom(context, context.getString(message), icon, ToastyUtils.getColor(context, tintColorRes),
                ToastyUtils.getColor(context, android.R.color.white), duration, withIcon, shouldTint);
    }
    ...
    private static Toast withLightTheme(@NonNull Context context, @NonNull CharSequence message, Drawable icon,
                                        int duration, boolean withIcon) {
        return custom(context, message, icon, ToastyUtils.getColor(context, R.color.normal_color),
                ToastyUtils.getColor(context, android.R.color.white), duration, withIcon, true);
    }

    private static Toast withDarkTheme(@NonNull Context context, @NonNull CharSequence message, Drawable icon,
                                       int duration, boolean withIcon) {
        return custom(context, message, icon, ToastyUtils.getColor(context, android.R.color.white),
                ToastyUtils.getColor(context, R.color.normal_color), duration, withIcon, true);
    }
